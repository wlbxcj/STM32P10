...
/* USART Flags ---------------------------------------------------------------*/
#define USART_FLAG_CTS                       ((u16)0x0200) //9
#define USART_FLAG_LBD                       ((u16)0x0100) //8
#define USART_FLAG_TXE                       ((u16)0x0080) //7
#define USART_FLAG_TC                        ((u16)0x0040) //6
#define USART_FLAG_RXNE                      ((u16)0x0020) //5
#define USART_FLAG_IDLE                      ((u16)0x0010) //4
#define USART_FLAG_ORE                       ((u16)0x0008) //3
#define USART_FLAG_NE                        ((u16)0x0004) //2
#define USART_FLAG_FE                        ((u16)0x0002) //1
#define USART_FLAG_PE                        ((u16)0x0001) //0
...
void UART_DataSend(USART_TypeDef *UARTx, u8 *Data, u8 DataLength);
