...
* File Name			 : fcntl.h
* Author             : guohonglv
* Date First Issued  : 2010年11月12日10:37:16
* Description        : 直接使用linux的头文件, 做了部分修改
********************************************************************************/
#ifndef FCNTL_H
#define FCNTL_H
...
#ifndef __USE_FILE_OFFSET64
extern int creat ( char *__file, int __mode) ;
#else
# ifdef __REDIRECT
...
extern int ftruncate (int __fd, unsigned int __length);
