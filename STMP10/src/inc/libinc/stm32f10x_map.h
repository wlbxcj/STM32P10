...
#define TIM5_BASE             (APB1PERIPH_BASE + 0x0C00) //gplian

#define RTC_BASE              (APB1PERIPH_BASE + 0x2800)
#define WWDG_BASE             (APB1PERIPH_BASE + 0x2C00)
#define IWDG_BASE             (APB1PERIPH_BASE + 0x3000)
#define SPI2_BASE             (APB1PERIPH_BASE + 0x3800)
#define SPI3_BASE             (APB1PERIPH_BASE + 0x3C00) //gplian
...
#define CRC_BASE              (AHBPERIPH_BASE + 0x3000) //12/10/23
...
#ifdef _CRC
#define CRC                 ((CRC_TypeDef *) CRC_BASE) //12/10/23
#endif /*_CRC */
