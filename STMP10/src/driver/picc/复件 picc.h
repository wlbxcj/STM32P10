...
#if 0
#define MF_IRQ    ((unsigned char)1<<(28-16))
#define MF_MX     ((unsigned char)1<<(29-16))
#define MF_RST    ((unsigned char)1<<(30-16))
#define MF_DTRQ   ((unsigned char)1<<(31-16))
// #define RF_CS	   ((unsigned char)1<<7)
#else
//#define MF_IRQ    ((unsigned char)1<<(28-16))
//#define MF_MX     ((unsigned char)1<<(29-16))
#define MF_RST    ((unsigned char)1<<(6))//13
//#define MF_DTRQ   ((unsigned char)1<<(31-16))
// #define RF_CS	   ((unsigned char)1<<7)
#define RF_CS_SPI_SS0	   ((unsigned char)1<<3)
...
/*
#define MF_IRQ    ((unsigned short)1<<(20-16))
#define MF_MX     ((unsigned short)1<<(21-16))
#define MF_RST    ((unsigned short)1<<(22-16))
#define MF_DTRQ   ((unsigned short)1<<(24-16))
*/
...
#define T_FIFO_LEVEL              16     //the FIFO warning byte threshold   26
...
#define printfx 	trace_debug_printf
