...
extern void dmult(NN_DIGIT a, NN_DIGIT b, NN_DIGIT *cHigh, NN_DIGIT *cLow);
...
unsigned int cDigits, dDigits;
{
    ...
    //test
    Lib_LcdPrintxy(0,8*1,0x00,"NN_ModMult begin");
   Lib_KbGetCh();
#endif     
...
#ifdef UARTPRINF_DEBUG
    //test
    Lib_LcdPrintxy(0,8*1,0x00,"NN_ASSIGN_DIGIT begin[%d]",dDigits);
   Lib_KbGetCh();
#endif
...
#ifdef UARTPRINF_DEBUG     
    //test
    Lib_LcdPrintxy(0,8*1,0x00,"NN_Digits begin[%d]",dDigits);
   Lib_KbGetCh();
#endif
...
#ifdef UARTPRINF_DEBUG     
    //test
    Lib_LcdPrintxy(0,8*1,0x00,"i[%d]",cDigits - 1);
   Lib_KbGetCh();
#endif
...
#ifdef UARTPRINF_DEBUG
    //test
    Lib_LcdPrintxy(0,8*1,0x00,"ciBits[%d]",ciBits);
   Lib_KbGetCh();
#endif          
...
#ifdef UARTPRINF_DEBUG            
    //test
    Lib_LcdPrintxy(0,8*1,0x00,"j[%d]ci[%d]t[%d]d[%d]dDigits[%d]",j,ci,t,d,dDigits);
   Lib_KbGetCh();
#endif   
...
#ifdef UARTPRINF_DEBUG
    //test
    Lib_LcdPrintxy(0,8*1,0x00,"1111");
   Lib_KbGetCh();
#endif               
...
#ifdef UARTPRINF_DEBUG               
    //test
    Lib_LcdPrintxy(0,8*1,0x00,"2222");
   Lib_KbGetCh();
#endif               
          }
...
#ifdef UARTPRINF_DEBUG     
    //test
    Lib_LcdPrintxy(0,8*1,0x00,"NN_Assign begin[%d]",dDigits);
   Lib_KbGetCh();
#endif
...
#ifdef UARTPRINF_DEBUG     
    //test
    Lib_LcdPrintxy(0,8*1,0x00,"NN_ModExp begin");
   Lib_KbGetCh();
#endif
...
#ifdef UARTPRINF_DEBUG     
    //test
    Lib_LcdPrintxy(0,8*1,0x00,"NN_ModExp end");
   Lib_KbGetCh();
#endif     
